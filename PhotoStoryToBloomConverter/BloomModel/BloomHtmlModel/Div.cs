...
namespace PhotoStoryToBloomConverter.BloomModel.BloomHtmlModel
{
	public class Div
	{
		...
		[XmlAttribute("data-xmatter-page")]
		public string DataXmatterPage { get; set; }
		...
		[XmlAttribute("data-audiorecordingmode")]
		public string AudioRecordingMode { get; set; }

		[XmlAttribute("data-default-languages")]
